...
public interface IFiveHundredPxApiHelper {
    Observable<List<Photo>> fetchPhotos(String category, boolean nextPage);

    Observable<Photo> getSinglePhoto(String photoId);
}
